...
class  ItemService extends PsService
{
    ...
    public function __construct(UserAccessApiTokenService $userAccessApiTokenService, PushNotificationTokenService $pushNotificationTokenService, BackendSettingService $backendSettingService, SearchHistoryService $searchHistoryService, UserService $userService, ImageService $imageService, CurrencyService $currencyService, LocationTownshipService $locationTownshipService, LocationCityService $locationCityService, CategoryService $categoryService, SubcategoryService $subcategoryService, ShopService $shopService, BlockUserService $blockUserService, SystemConfigService $systemConfigService, UserInfoService $userInfoService, SubCatSubscribeService $subCatSubscribeService, VendorService $vendorService)
    {
