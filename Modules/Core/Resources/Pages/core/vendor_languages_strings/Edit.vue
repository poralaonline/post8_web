        ...
        <ps-card class="w-full h-auto">
            <div class="rounded-xl">
                ...
                <div class="px-4 pt-6 dark:bg-backgroundDark">
                    <form @submit.prevent="handleSubmit(this.vendor_language_string.id)">
...
export default defineComponent({
    ...
    layout: PsLayout,
    props: ['errors', 'vendor_language_string', 'language'],
    data() {
        return {
            form: useForm(
                {
                    key: this.vendor_language_string.key,
                    value: this.vendor_language_string.value,
    ...
    setup(props) {
        ...
        let form = useForm(
            {
                key: props.vendor_language_string.key,
                value: props.vendor_language_string.value,
                language_id: props.language.id,
                id: props.vendor_language_string.id,
                "_method": "put"
            }
        )

        function handleSubmit(id) {
            this.$inertia.post(route('vendor_language_string.update', [props.language, id]), form, {
                forceFormData: true,
        ...
        breadcrumb() {
            ...
            return [
                ...
                },
                {
                    ...
                    url: route('vendor_language_string.index', this.language.id),
                },
                {
                    label: "Edit Vendor Language String",
    ...
    methods: {
        handleCancel() {
            this.$inertia.get(route('vendor_language_string.index', this.language.id));
        },
    },
})
</script>
