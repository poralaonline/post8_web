<template>
    <Head :title="$t('create_vendor_language_string')" />
    <ps-layout>
        <!-- breadcrumb start -->
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function handleSubmit() {
            this.$inertia.post(route('vendor_language_string.store', props.language), form, {
                forceFormData: true,
    ...
    computed: {
        breadcrumb() {
            ...
            return [
                ...
                {
                    label: trans('create_vendor_language_string'),
