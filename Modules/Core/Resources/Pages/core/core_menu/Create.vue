...
export default defineComponent({
    ...
    setup(props) {
        ...
        const validationAttributes = {
            ...
            core_sub_menu_group_id: "Sub Menu Group Id",
        ...
        const validateEmptyInput = (fieldName, fieldValue) => {
            ...
            const attribute = validationAttributes[fieldName];
            if (!fieldValue) {
                // Field is empty, set an error message using the attribute
                props.errors[fieldName] = `The ${attribute} field is required`;
            } else {
                // Field is not empty, clear the error message
