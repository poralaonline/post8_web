            ...
            <div class="rounded-xl">
                ...
                <div class="px-4 pt-6 dark:bg-backgroundDark">
                    ...
                    <div class="grid w-full sm:w-1/2 gap-6">
                        ...
                        <div>
                            <ps-label class="text-base">{{$t('payment__be_pmt_desc')}}<span class="text-red-500 ms-1">*</span></ps-label>
        ...
        function handleSubmit() {
            this.$inertia.post(route("payment.store"), form, {
                ...
                onError: () => {
                    ...
                    description.value.isError = ('description' in props.errors) ? true : false;
                    loading.value = false;
                },
            });
        }
