          ...
          <form @submit.prevent="handleSubmit">
            <div class="grid w-full sm:w-1/2 gap-6">
              ...
              <div>
                ...
                <ps-dropdown align="left" class='lg:mt-2 mt-1  w-full'>
                  <template #select>
                    <ps-dropdown-select ref="currency_id" :placeholder="$t('payment__be_select_currency')"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    function handleSubmit() {
      this.$inertia.post(route("vendor_subscription_plan.store"), form, {
        forceFormData: true,
        onBefore: () => {
          loading.value = true;
        },
    ...
    return { currency_id, type, price, onlyNumber, onlyNumberWithCustom, validatePriceInput, validateEmptyInput, validateInAppPurchasePrdIdInput, handleSubmit, form, loading, success, in_app_purchase_prd_id, durations };
  },
  computed: {
    breadcrumb() {
      ...
      return [
        ...
        {
            label: trans('core__be_add_vendor_subscription_plan'),
