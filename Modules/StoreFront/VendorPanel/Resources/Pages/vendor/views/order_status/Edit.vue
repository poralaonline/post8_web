        ...
        <ps-card class="w-full h-auto">
            <div class="rounded-xl">
                ...
                <div class="px-4 pt-6 dark:bg-backgroundDark">
                    <form @submit.prevent="handleSubmit(orderStatus.vendor_id, orderStatus.id)">
...
export default defineComponent({
    ...
    setup(props) {
        ...
        let form = useForm({
            ...
            status: props.orderStatus.status == 1 ? true : false,
            "_method": "put"
        });

        function handleSubmit(vendor_id, id) {
            this.$inertia.post(route("vendor_order_status.update", [vendor_id, id]), form, {
                forceFormData: true,
                onBefore: () => {
                    loading.value = true;
                },
    ...
    computed: {
        breadcrumb() {
            ...
            return [
                ...
                {
                    label: trans('vendor_panel__edit_order_status'),
