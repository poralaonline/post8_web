<template>
    <div class="w-full lg:rounded-lg sm:rounded-xl rounded-2xl sm:flex mt-4 sm:mt-0 gap-5">
        <div class="flex gap-x-5 flex-col md:flex-row gap-y-2">
                ...
                <ps-input-with-left-icon theme="dark:text-feSecondary-200" placeholderColor="" rounded="rounded" defaultBorder="bg-feSecondary-50 dark:bg-feSecondary-800 border border-feAchromatic-50 hover:border-feSecondary-400 
                ...
                <div class="md:block hidden">
                    <ps-label textColor="text-2xl mt-1 font-medium text-feSecondary-100 dark:text-feSecondary-50">{{ $t("|") }}</ps-label>
                </div>

                <ps-dropdown h="h-64" align="left" class='w-full md:w-52 h-full lg:rounded-2xl rounded' @onClick="loadSubLocation()">
                    <template #select>
                                ...
                                <template #icon>
                                    ...
                                    <template #removeIcon>
                                       <div v-if="categoryStore.filterKeyword !=''">
                                        <ps-icon textColor="text-feAchromatic-500 dark:text-feAchromatic-500" @click="[categoryStore.filterKeyword = '', filtersubLocationUpdate(categoryStore.filterKeyword)]" name="cross" class='cursor-pointer' />
                    ...
                    <template #filter >
                        <div>
                            <ps-input-with-left-icon class="bg-feSecondary-50 dark:bg-transparent shadow-none" rounded="rounded-none" theme="border-none  focus:ring-0 focus:ring-transparent text-feSecondary-500 dark:text-feAchromatic-50" height="h-10" 
                                @keyup.capture="filterKeywordUpate(itemLocationStore.filterKeyword)"  v-model:value="itemLocationStore.filterKeyword" v-bind:placeholder= "$t('search_location')">
                                <template #icon>
                                    <ps-icon textColor="text-fePrimary-500 dark:text-feAchromatic-500" name="search" class='cursor-pointer'  />
                                </template>
                ...
                <div class="flex justify-center">
                    ...
                    <ps-button v-bind:title="$t('search_for_large_screem__search')" class="" rounded="rounded-3xl" theme="bg-fePrimary-500" @click="searchClicked()">
                        <ps-icon textColor="text-feAchromatic-50 dark:text-feSecondary-50" name="search" h="24" w="24" class='cursor-pointer' />
                        <ps-label class="text-sm font-medium pl-2" textColor="text-feAchromatic-50 dark:text-feSecondary-50"> {{ $t("search_for_large_screem__search") }} </ps-label>
                    </ps-button>
                </div>
