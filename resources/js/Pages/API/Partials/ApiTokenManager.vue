<template>
    <div>
        ...
        <jet-form-section @submitted="createApiToken">
            ...
            <template #actions>
                <jet-action-message :on="createApiTokenForm.recentlySuccessful" class="me-3">
                    Created.
                </jet-action-message>
        ...
        <jet-dialog-modal :show="managingPermissionsFor" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                ...
                <jet-button class="ms-3" @click="updateApiToken" :class="{ 'opacity-25': updateApiTokenForm.processing }" :disabled="updateApiTokenForm.processing">
                    {{ $t('core__be_btn_save') }}
                </jet-button>
            </template>
        </jet-dialog-modal>
        ...
        <jet-confirmation-modal :show="apiTokenBeingDeleted" @close="apiTokenBeingDeleted = null">
            ...
            <template #footer>
                ...
                <jet-danger-button class="ms-3" @click="deleteApiToken" :class="{ 'opacity-25': deleteApiTokenForm.processing }" :disabled="deleteApiTokenForm.processing">
